...
# To install: brew tap php-workx/tap && brew install rtk
class Rtk < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/php-workx/agentic-rtk/releases/download/v#{version}/rtk-x86_64-apple-darwin.tar.gz"
      sha256 "PLACEHOLDER_SHA256_INTEL"
    end

    on_arm do
      url "https://github.com/php-workx/agentic-rtk/releases/download/v#{version}/rtk-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    ...
    on_arm do
      url "https://github.com/php-workx/agentic-rtk/releases/download/v#{version}/rtk-aarch64-unknown-linux-gnu.tar.gz"
