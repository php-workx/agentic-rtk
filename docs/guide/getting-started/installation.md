...
- **Rust Token Killer** (`php-workx/agentic-rtk`) — this project, a token-saving CLI proxy
...
```bash
brew install php-workx/tap/rtk
```
...
```bash
cargo install --git https://github.com/php-workx/agentic-rtk rtk
```

## Pre-built binaries (Windows, Linux, macOS)

Download from [GitHub releases](https://github.com/php-workx/agentic-rtk/releases):
